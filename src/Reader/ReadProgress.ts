import {FB3ReadProgressCache} from "./ReadProgressCache";
import {FB3Reader} from "./FB3Reader";
import {FB3ReaderPage} from "./FB3ReaderPage";
import {IBookReadProgress, IBookReadProgressInfo} from "./ReadProgress.head";
...
export module FB3BookReadProgress {
    ...
    class BookReadProgressInfo implements IBookReadProgressInfo {
        ...
        private Inc(Pos: IPosition) {
            var newPos: IPosition = Pos.slice(0);
            if (Pos.length > 0) {
                Pos[Pos.length - 1] += 1;
            }
            return Pos;
        ...
        private CompactReadRanges() {
            ...
            var newRanges: IRange[] = this.ReadRanges.slice(0, 1);
        ...
        */
        ...
        private isGreaterLeft(RangeA: IPosition, RangeB: IPosition): boolean {
            var IsLeft = true;
            return this.isGreater(RangeA, RangeB /*, IsLeft */);
        }

        private isGreaterRight(RangeA: IPosition, RangeB: IPosition): boolean {
